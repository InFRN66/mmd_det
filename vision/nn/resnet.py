...
class _Basicblock(nn.Module):
    def __init__(self, in_channel, out_channel, stride=1, expansion=1, downsample=None):
        ...
        self.conv2 = nn.Conv2d(out_channel, out_channel*expansion, kernel_size=3, stride=1, padding=1, bias=False)
...
class _Bottleneck(nn.Module):
    def __init__(self, in_channel, out_channel, stride=1, expansion=4, downsample=None):
        ...
        self.conv3 = nn.Conv2d(out_channel, out_channel*expansion, kernel_size=1, bias=False)
...
def resnet(conv_defs, depth_multiplier=1.0, min_depth=8):
    # print('rerererr')
    # print(conv_defs, depth_multiplier, min_depth)
